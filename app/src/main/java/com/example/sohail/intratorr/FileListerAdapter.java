                ...
                public boolean accept(File file) {
                    switch (getFileFilter()) {
                        case ALL_FILES:
                            return true;
                        case AUDIO_ONLY:
                            return isAudio(file) || file.isDirectory();
                        case IMAGE_ONLY:
                            return isImage(file) || file.isDirectory();
                        case VIDEO_ONLY:
                            return isVideo(file) || file.isDirectory();
                        case DIRECTORY_ONLY:
...
//                    onFileSelectedListener.onFileSelected(f, f.getAbsolutePath());
                }
            }
        }
    }
